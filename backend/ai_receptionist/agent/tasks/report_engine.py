...
class ReportEngine:
    ...
    def generate_report(self, metrics: Dict[str, Any], scenario: Dict[str, Any]):
        ...
        print(
            f"**Summary**: {qual.get('emotional_tone', 'N/A')} tone. UX Score: {qual.get('ux_score', 0)}/100."
        )
        ...
        action_items = {"severity": severity, "actions": actions}
        ...
        next_automation = {
            ...
            "reason": (
                "UX score below threshold" if severity != "minor" else "Performance acceptable"
            ),
            "severity": severity,
