...
def test_language_selection_english():
    ...
    response = client.post(
        "/twilio/language-selected", data={"CallSid": "CA_test_456", "Digits": "1"}
    )
...
def test_language_selection_spanish():
    ...
    response = client.post(
        "/twilio/language-selected", data={"CallSid": "CA_test_789", "Digits": "2"}
    )
...
def test_gather_hours_intent():
    ...
    client.post("/twilio/language-selected", data={"CallSid": "CA_test_hours", "Digits": "1"})

    # Then ask about hours
    response = client.post(
        "/twilio/gather", data={"CallSid": "CA_test_hours", "SpeechResult": "What are your hours?"}
    )
...
def test_gather_services_intent():
    ...
    # First select language
    client.post("/twilio/language-selected", data={"CallSid": "CA_test_services", "Digits": "1"})
...
def test_gather_goodbye_intent():
    ...
    # First select language
    client.post("/twilio/language-selected", data={"CallSid": "CA_test_goodbye", "Digits": "1"})

    # Then say goodbye
    response = client.post(
        "/twilio/gather", data={"CallSid": "CA_test_goodbye", "SpeechResult": "Thank you, goodbye"}
    )
...
def test_repeat_endpoint():
    ...
    # First select language
    client.post("/twilio/language-selected", data={"CallSid": "CA_test_repeat", "Digits": "1"})

    response = client.post("/twilio/repeat", data={"CallSid": "CA_test_repeat"})
    ...
    assert (
        "repeat" in xml_content.lower()
        or "didn't" in xml_content.lower()
        or "sorry" in xml_content.lower()
    )
...
def test_session_state_persistence():
    ...
    # Select language
    client.post("/twilio/language-selected", data={"CallSid": call_sid, "Digits": "1"})
    ...
    response = client.post(
        "/twilio/gather", data={"CallSid": call_sid, "SpeechResult": "What are your hours?"}
    )
